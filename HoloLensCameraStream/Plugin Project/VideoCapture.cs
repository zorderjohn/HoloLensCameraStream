...
namespace HoloLensCameraStream
{
	...
	public sealed class VideoCapture
	{
		...
		public async void StartVideoModeAsync(CameraParameters setupParams, OnVideoModeStartedCallback onVideoModeStartedCallback)
		{
			...
			IVideoEffectDefinition ved = new VideoMRCSettings(
				setupParams.enableHolograms,
				setupParams.enableVideoStabilization,
				setupParams.videoStabilizationBufferSize,
				setupParams.hologramOpacity,
				setupParams.enableRecordingIndicator);
	...
	public class VideoMRCSettings : IVideoEffectDefinition
	{
		...
		public VideoMRCSettings(
			...
			int VideoStabilizationBufferLength,
			float GlobalOpacityCoefficient,
			bool RecordingIndicator)
		{
			...
			Properties.Add("RecordingIndicatorEnabled", RecordingIndicator);
		}
	}
}
