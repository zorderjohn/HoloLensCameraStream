...
namespace HoloLensCameraStream
{
	public class VideoCaptureSample
	{
		...
		private static Matrix4x4 invZ = Matrix4x4.CreateScale(1f, 1f, -1f);
		Matrix4x4 DoubleZNeg(Matrix4x4 matrix)
		{
			// https://stackoverflow.com/questions/30234945/change-handedness-of-a-row-major-4x4-transformation-matrix
			return invZ * matrix * invZ;
		}
		Matrix4x4 ZNeg(Matrix4x4 matrix)
		{
			// https://stackoverflow.com/questions/30234945/change-handedness-of-a-row-major-4x4-transformation-matrix
			return matrix * invZ;
		}
		...
		public bool TryGetCameraToWorldMatrix(out float[] outMatrix, MatrixMode mode = MatrixMode.ZNeg)
		{
			...
			if (mode == MatrixMode.ZNeg)
			{
				viewToWorldInUnityCoordsMatrix = ZNeg(viewToWorldInUnityCoordsMatrix);
			...
			else if (mode == MatrixMode.DoubleZNeg)
			{
				viewToWorldInUnityCoordsMatrix = DoubleZNeg(viewToWorldInUnityCoordsMatrix);
			}
